...
public class HashKnv25 extends HashFunction {
     ...
     * @param       input           Input bytes (length must be a multiple of 8)
    ...
    public byte[] hash(final byte input[]) {
        ...
        while (inputOffset<=inputLength) {
            ...
            while (inputOffset<inputLength && i<17) {
                state[i++] ^= ((long)(input[inputOffset++] & 0xFF)) | 
                        (((long)(input[inputOffset++] & 0xFF)) << 8) | 
            ...
            long state0 = state[0], state1 = state[1], state2 = state[2], state3 = state[3], state4 = state[4], 
                    state5 = state[5], state6 = state[6], state7 = state[7], state8 = state[8], state9 = state[9], 
                    state10 = state[10], state11 = state[11], state12 = state[12], state13 = state[13], 
                    state14 = state[14], state15 = state[15], state16 = state[16], state17 = state[17], 
                    state18 = state[18], state19 = state[19], state20 = state[20], state21 = state[21], 
                    state22 = state[22], state23 = state[23], state24 = state[24];
            for (i=0; i<25; ) {
